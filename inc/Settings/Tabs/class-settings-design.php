		...
		$settings = apply_filters(
			...
			array(
				...
				array(
					...
					'type'    => 'image-radio',
					'options' => array(
						'default' => array( 'label' => __( 'Default', 'analogwp-library' ), 'image' => AGWP_LIBRARY_PLUGIN_URL . 'assets/img/preset-default.png' ),
						'light'   => array( 'label' => __( 'Light', 'analogwp-library' ), 'image' => AGWP_LIBRARY_PLUGIN_URL . 'assets/img/preset-light.png' ),
						'dark'    => array( 'label' => __( 'Dark', 'analogwp-library' ), 'image' => AGWP_LIBRARY_PLUGIN_URL . 'assets/img/preset-dark.png' ),
						'color'   => array( 'label' => __( 'Color', 'analogwp-library' ), 'image' => AGWP_LIBRARY_PLUGIN_URL . 'assets/img/preset-color.png' ),
					),
					'default' => 'default',
				),
				array(
