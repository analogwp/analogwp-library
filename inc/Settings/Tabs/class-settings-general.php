		...
		if ( '' === $current_section ) {
			...
			$settings = array(
				...
				array(
					...
					'desc_tip' => __( 'Removes the default template library icon from the editor toolbar.', 'analogwp-library' ),
					'type'     => 'checkbox',
					'default'  => false,
				),
				array(
					...
					'desc_tip' => __( 'Stops the default template library popup from appearing when you open Theme Builder pages.', 'analogwp-library' ),
					'type'     => 'checkbox',
					'default'  => false,
				),
				array(
